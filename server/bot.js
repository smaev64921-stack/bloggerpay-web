...
/* Куда ведёт кнопка. Обычно НИКУДА ВПИСЫВАТЬ НЕ НАДО: сайт раздаёт сам
   сервер, значит его адрес (PUBLIC_URL) и есть адрес сайта — бот соберёт
   ссылку сам. APP_URL нужен только если сайт почему-то лежит отдельно,
   на стороннем хостинге; заданный, он перебивает PUBLIC_URL.

   Осторожно с забытым APP_URL: если в настройках остался адрес прежнего
   хостинга, кнопка поведёт людей туда, а не на нынешний сайт. */
